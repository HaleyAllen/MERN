...
const obj1 = {
  ...
  function insert(tableName, columnValuePairs) {
    let objectEntries = Object.entries(columnValuePairs);
    let keys=""
    let values=""
    for (let i=0;i<columnValuePairs.length;i++){
      keys += objectEntries[i][0] + ", "
      values += objectEntries[i][1] + ", "
    }
    sqlString= `INSERT INTO ${tableName} VALUES (${key});`
  }
